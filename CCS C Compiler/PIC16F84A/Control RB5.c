...
void main(VOID) {
   set_tris_b (0xDF);         //Configuramos RB5 como salida (Binario:11011111)
   DO{
      output_low (PIN_B5);    //Pone RB5 en estado logico bajo
      delay_ms (500);         //Espera 500 milisegundos
      output_high (PIN_B5);   //Pone RB5 en estado logico alto
      delay_ms (500);         //Espera 500 milisegundos

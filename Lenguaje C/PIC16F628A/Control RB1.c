 ...
 * Descripcion: Configura el purto B como salida y alterna el pin RB1 entre un 
...
void main(void) {				  //Funcion principal
	...
	while (1) {					    //Bucle infinito
		PORTBbits.RB1 = 0;		//Pone RB1 en estado bajo
		__delay_ms(500);		  //Crea un retardo de 500 milisegundos
		PORTBbits.RB1 = 1;		//Pone RB1 en estado alto
		__delay_ms(500);		  //Crea un retardo de 500 milisegundos
	}
    return;
}
